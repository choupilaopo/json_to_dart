    ...
    return Container(
        ...
        child: Stack(children: [
          ...
          Positioned(
            ...
            child: ElevatedButton(
                onPressed: () async {
                  ...
                  File f = File('$path/${transformName("${widget.clzName}Model")}.dart');
          ...
          Positioned(
              bottom: 0,
              right: 190,
              child: getTipWidget(showTip: '注意', toastTip: '默认的类名为 Autogenerated', showDown: false))
        ]));
  }
