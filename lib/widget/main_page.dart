...
import '../util/map_to_dart_util.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  void transJsonToDart() {
    setState(() {
      ...
      DEFAULT_NAME = getClzName;

      try {
        TextSpan textSpanRes =
            MapToDartTextSpanUtil.trans(targetMap, name: DEFAULT_NAME, needDecodeFunction: needDecodeFunction);
        String text = MapToDartUtil.trans(targetMap, name: DEFAULT_NAME);
